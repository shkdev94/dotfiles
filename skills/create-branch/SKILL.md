...
- 여러 단계의 작업도 각 단계의 목적에 맞는 동일한 브랜치 형식을 사용한다. 시작 지점과 의존 순서는 함께 적용하는 PR 스킬이나 합의된 작업 계획을 따른다.
- 시작 브랜치나 기존 선행 작업의 브랜치는 이 규칙에 맞춰 변경하지 않는다.
...
# DEFAULT_BRANCH에는 위에서 확인한 refs/heads/ 아래의 실제 이름을 사용
